...
\fancypagestyle{first}{%
  ...
  \fancyfoot[L]{{\footnotesize \textsf{DOI: \href{10.4236/jdaip.2025.*****}{\color{blue}\uline{10.4236/jdaip.2025.*****}} $\;$JDAIP **, 2025}}}%
  \fancyhead[R]{{\bf\small \textsf{Journal of Data Analysis and Information Processing, 2025, *(*), *-*}}\\
\href{http://www.scirp.org/journal/jdaip}{\color{blue}\uline{\textsf{http://www.scirp.org/journal/jdaip}}}\\
\textsf{ISSN Online:****-****}\\
\textsf{ISSN Print:****-****}}%
...
\noindent{\bf How to cite this paper:} O.S. Omoshola (2025) Network Analysis for Systemic Risk Assessment in Supply Chains: A Cross-Disciplinary Framework Integrating Financial Contagion Models, Journal of Data Analysis and Information Processing, {\bf *},    *-*.\\
...
\label{ref35}[35] Jenks, G.F. (1967) The data model concept in statistical mapping. \emph{International Yearbook of Cartography}, 7:186-190.
